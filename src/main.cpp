...
int main() {
    try {
        ...
        while (!Window::isShouldClose()) {
            ...
            objTexture.passToShader(lightingShader, "objectTexture");
            objTexture.passTextureToShader(GL_TEXTURE0);

            specTexture.passToShader(lightingShader, "specularMapTexture");
